    ...
    <div :class="isLabelVisible && 'flex items-center'">
      ...
      <div class="flex justify-end">
        ...
        <q-input
          ...
          } pt-border-radius-50 pt-border-accent-0 pt-input-field height-${fieldHeight} use-input q-px-md q-mr-md`"
          dense
          borderless
          v-model="keyword"
          placeholder="Search"
          ...
          ><template v-slot:append>
            <q-icon
              ...
              name="close"
              @click="fetchAll()"
              class="cursor-pointer pt-text-accent-0"
            />
            <q-icon
              @click="searchKeyword()"
        ...
        <q-select
          ...
          option-value="value"
          option-label="label"
          :class="`minmax-width pt-border-accent-0 pt-border-radius-50 pt-select-field height-31 text-14 ${
            ...
            <div v-if="isDateRangeVisible" class="q-px-sm">
              ...
              <q-form ref="formDateRange" greedy>
                ...
                <div class="q-mt-xs">
                  <label>To</label>
                  <q-input
                    class="filter-date-field pt-border-radius-5 pt-input-field pt-border-accent-0 label-accent-2 q-px-sm"
                    v-model="toDate"
                    readonly
                    borderless
                    dense
              ...
              <div class="q-mb-md q-mt-sm">
                <q-btn
                  ...
                  class="apply-btn pt-border-radius-15 pt-bg-accent-0 border-white full-width"
                  label="Apply"
