<template>
  <div>
    <div class="bg-white q-pa-lg">
      ...
      <q-card
        class="pt-mobile-card pt-border-radius-15 overflow-hidden q-mb-sm no-shadow pt-border-accent-0"
      >
          ...
          <div class="flex justify-between q-pa-md items-center">
            ...
            <div class="text-20">
              <q-btn
                ...
                round
                icon="more_vert"
                class="pt-text-primary pt-text-hover-accent-1"
              >
                <q-menu>
                  <q-list>
                    <q-item clickable v-close-popup class="menu-list">
        ...
        <div class="q-pa-md">
          ...
          <div class="flex justify-between">
            <div class="pt-text-accent-2">Date</div>
            <div>#####</div>
          </div>
        </div>
      </q-card>
