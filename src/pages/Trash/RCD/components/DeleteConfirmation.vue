<template>
  <div class="user-delete width-300">
    ...
    <q-btn
      ...
      label="Yes, Im sure"
      dense
      :class="`pt-bg-accent-0 text-black full-width q-py-sm q-mb-s pt-border-radius-${
  ...
  setup() {
    ...
    const showNotify = () => {
      ...
      $q.notify({
        ...
        html: true,
        message: status
          ? `<div class="text-bold">RCD Trash deleted permanently!</div> RCD has been deleted permanently.`
