    ...
    <div class="log-book pt-text-primary">
      <div v-if="!pageLoadingState">
        <div class="q-px-lg q-pt-lg gt-xs">
          ...
          >
            <h5 class="text-28 text-weight-medium q-my-none">Trash | RCI</h5>
            <q-btn
              v-if="showDeleteBtn"
              rounded
              dense
        ...
        <div class="pt-main-scroll table-scroll">
          ...
          >
            ...
            <template v-if="!listOfRCI.length" v-slot:bottom-row>
              <q-tr>
        ...
        <div class="show-on-mobile q-pa-lg">
          <div v-for="list in listOfRCI" :key="list.id">
            <RCICard :list="list" />
          </div>
...
<script src="./script/RCI.js"></script>

<style lang="scss">
@import "./style/RCI.scss";
</style>
